...
- `SELECT` (including nested selections)
- `FROM`
- `WHERE`
- `ORDER BY`
- `LIKE`
...
I believe these commands can be seen as the essential commands of SQL. Once these are understood fluently, the rest can easily fall into place.

## Technology Used

To make this game, I plan to use the Unity engine because of my previous familiarity with it, and its ease of use for both 2D and 3D games. In particular, I'll use version 6.2, the most recent version at the time of creation.
